...
class _MiMonederoTabPageState extends State<MiMonederoTabPage> {
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              (_perfil == "CLIENTE")
                ? Padding(
                  padding: EdgeInsets.only(bottom: 5.0, top: 0.08 * screenSizeHeight), //bottom: 20.0, top: 50.0
                  child: _transferirButton(),
                )
                : StreamBuilder<bool>(
                  stream: BlocProvider.of<ServiciosBloc>(context).isPidChasActive$,
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('Pidos disponibles', style: TextStyle( fontSize: 20.0, color: Colors.white )),
          ],
        )
      ),
    );
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                // SizedBox(width: screenSizeWidth * 0.022), //width: 8.0
                Text('30,00', style: TextStyle( fontSize: 35.0, fontWeight: FontWeight.w700,color: Colors.white )),
              ],
            ),
            Text('Pid Cash', style: TextStyle( fontSize: 20.0, color: Colors.white )),
            Text('disponibles', style: TextStyle( fontSize: 20.0, color: Colors.white )),
          ],
        )
      ),
    );
  ...
  Widget _dotsIndicator(){
    return Padding(
      ...
      child: DotsIndicator(
        ...
        onTap: (position) {
          setState(() {
            _pageController.animateToPage(position.toInt(), duration: Duration(milliseconds: 400), curve: Curves.ease);
          });
        },
      )
    );
  ...
  Widget _comprarButton(BuildContext  context){
    return Padding(
      padding: EdgeInsets.symmetric(vertical: screenSizeHeight * 0.00844, horizontal: screenSizeWidth * 0.125  ), //vertical: 5.0, horizontal: 30.0
      child: SizedBox(
        width: double.infinity,
        child: RaisedButton(
          child: Container( 
            padding: EdgeInsets.symmetric( vertical: screenSizeHeight * 0.0168 ), //vertical: 15.0
            child: Text(
              'Comprar',
              style: TextStyle(
                fontWeight: FontWeight.w700,
