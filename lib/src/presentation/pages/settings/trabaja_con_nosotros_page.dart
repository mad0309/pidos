...
class TrabajaConNosotrosPage extends StatelessWidget {
          ...
          child: Column(
            ...
            children: [
              Padding(
                ...
                child: Text('Trabaja con nosotros',textAlign: TextAlign.center ,style: TextStyle(fontFamily: 'Raleway',color: primaryColor, fontSize: 30.0,fontWeight: FontWeight.w700)),
              ),
              Padding(
                padding: EdgeInsets.symmetric(vertical: 10.0, horizontal: 80.0),
                child: Text('Tu también puedes trabajar con nosotros',textAlign: TextAlign.center, style: TextStyle(color: Color(0xFF666666), fontSize: 18.0)),
              ),
              Padding(
  ...
  _launchURL() async {
    const url = 'https://pidoscolombia.com/contacto';
