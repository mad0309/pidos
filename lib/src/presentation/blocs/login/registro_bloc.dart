...
class RegistroBloc extends MyBaseBloc {
  ...
  factory RegistroBloc(
      {UsuarioRepository usuarioRepository, Validators validators}) {
    //controllers
    ...
    final terminosYcondicionesEmpresaController =
          ...
          if (tipoRegistroController.value == TipoRegistro.persona) {
            ...
            return _onSubmitFormEmpresa(
                ...
                terminosYcondiciones:
                    terminosYcondicionesEmpresaController.value);
          }
        })
        .share()
        .publish();
    ...
    final repetirContrasenaEmpresa$ =
        repetirContrasenaEmpresaController.shareValue();
    ...
    final terminosYcondicionesEmpresa$ =
        terminosYcondicionesEmpresaController.shareValue();
    ...
    final isValidNroDocumento$ =
        nroDocumento$.transform(validators.validatorNroDoucumento);
    final isValidContrasena$ =
        contrasena$.transform(validators.validatorContrasena);

    final isValidRazonSocial$ =
        razonSocial$.transform(validators.validatorNombre);
    final isValidNit$ = nit$.transform(validators.validatorNit);
    final isValidCorreoEmpresa$ =
        correoEmpresa$.transform(validators.validatorEmail);
    final isValidContrasenaEmpresa$ =
        contrasenaEmpresa$.transform(validators.validatorContrasena);
    final isValidCodigoDeVendedor$ =
        codigoDeVendedor$.transform(validators.validatorCodigoVendedor);
    ...
    final subscriptions = <StreamSubscription>[
      ...
      terminosYcondiciones$.listen(
          (value) => print('[REGISTRO_BLOC] terminosYcondiciones=$value')),
      terminosYcondicionesEmpresa$.listen((value) =>
          print('[REGISTRO_BLOC] terminosYcondicionesEmpresa=$value')),
      registroMessage$.listen(
          (message) => print('[REGISTRO_BLOC] registroMessage=$message')),
      isValidNombre$
          .listen((value) => print('[REGISTRO_BLOC] isValidNombre=$value')),
      isValidApellido$
          .listen((value) => print('[REGISTRO_BLOC] isValidApellido=$value')),
      isValidEmail$
          .listen((value) => print('[REGISTRO_BLOC] isValidEmail=$value')),
      isValidNroDocumento$.listen(
          (value) => print('[REGISTRO_BLOC] isValidNroDocumento=$value')),
      isValidContrasena$
          .listen((value) => print('[REGISTRO_BLOC] isValidContrasena=$value')),
      cleanControllers$
          .listen((_) => print('[REGISTRO_BLOC] cleanControllers executed')),
      razonSocial$
          .listen((value) => print('[REGISTRO_BLOC] razonSocial=$value')),
      nit$.listen((value) => print('[REGISTRO_BLOC] nit=$value')),
      correoEmpresa$
          .listen((value) => print('[REGISTRO_BLOC] correoEmpresa=$value')),
      contrasenaEmpresa$
          .listen((value) => print('[REGISTRO_BLOC] contrasenaEmpresa=$value')),
      repetirContrasenaEmpresa$.listen(
          (value) => print('[REGISTRO_BLOC] repetirContrasenaEmpresa=$value')),
      codigoDeVendedor$
          .listen((value) => print('[REGISTRO_BLOC] codigoDeVendedor=$value')),
      rut$.listen((value) => print('[REGISTRO_BLOC] rut=${value?.path ?? ''}')),
      camaraDeComercio$.listen((value) =>
          print('[REGISTRO_BLOC] camaraDeComercio=${value?.path ?? ''}')),
      cedula$.listen(
          (value) => print('[REGISTRO_BLOC] cedula=${value?.path ?? ''}')),
      logo$.listen(
          (value) => print('[REGISTRO_BLOC] logo=${value?.path ?? ''}')),
      isValidRazonSocial$.listen(
          (value) => print('[REGISTRO_BLOC] isValidRazonSocial=$value')),
      isValidNit$.listen((value) => print('[REGISTRO_BLOC] isValidNit=$value')),
      isValidCorreoEmpresa$.listen(
          (value) => print('[REGISTRO_BLOC] isValidCorreoEmpresa=$value')),
      isValidContrasenaEmpresa$.listen(
          (value) => print('[REGISTRO_BLOC] isValidContrasenaEmpresa=$value')),
      isValidCodigoDeVendedor$.listen(
          (value) => print('[REGISTRO_BLOC] isValidCodigoDeVendedor=$value')),
    ...
    return RegistroBloc._(
      ...
      onChangedTerminosYcondicionesEmpresa:
          terminosYcondicionesEmpresaController.sink.add,
      nombre$: nombre$,
      apellido$: apellido$,
      email$: email$,
  ...
  static Stream<RegistroMessage> _onSubmitForm(
      ...
      bool terminosYcondiciones}) async* {
    try {
